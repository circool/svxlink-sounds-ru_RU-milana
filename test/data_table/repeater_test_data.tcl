...
set dataTests {
	{"startup" "на частоте работает репитер Роман двойка Анна Дмитрий Ульяна"}
	{"manual_identification" "на частоте работает репитер Роман двойка Анна Дмитрий Ульяна Текущее время тринадцать часов сорок семь минут Частота субтона восемьдесят пять целых и пять десятых Герц активный модуль Эхо линк ноль подключенных станций"}
	{"send_short_ident" "-1" "-1" "репитер Роман двойка Анна Дмитрий Ульяна"}
	{"send_long_ident" "11" "51" "репитер Роман двойка Анна Дмитрий Ульяна Текущее время одиннадцать часов пятьдесят одна минута"}
	{"logic_online" "1" "на частоте работает репитер Роман двойка Анна Дмитрий Ульяна"}
	{"logic_online" "0" ""}
	{"repeater_up" "SQL_CLOSE" ""}
	{"repeater_down" "IDLE" "репитер Роман двойка Анна Дмитрий Ульяна"}
