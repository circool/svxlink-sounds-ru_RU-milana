...
set dataTests {
	...
	{"manual_identification" "на частоте работает репитер Роман двойка Анна Дмитрий Ульяна дробь Роман Текущее время тринадцать часов сорок семь минут Частота субтона восемьдесят пять целых и пять десятых Герца активный модуль Эхо линк ноль подключенных станций"}
	...
	{"repeater_down" "IDLE" "звучит тон 400 900 50 звучит тон 360 900 50"}
	{"repeater_down" "SQL_FLAP_SUP" "репитер выключается из-за помех"}
	{"repeater_idle" "звучит тон 1100 150 100 звучит тон 1200 150 100 звучит тон 1100 75 100 звучит тон 1200 75 100 звучит тон 1100 38 100 звучит тон 1200 38 100 звучит тон 1100 19 100 звучит тон 1200 19 100 звучит тон 1100 9 100 звучит тон 1200 9 100 звучит тон 1100 5 100 звучит тон 1200 5 100 звучит тон 1100 2 100 звучит тон 1200 2 100 звучит тон 1100 1 100 звучит тон 1200 1 100"}
