...
- [ ] Модуль MetarInfo
    ...
    - [X] Переписать фразу "all_runways_clr" (Все взлетно-пасадочные полосы чисты")
    - [X] Переписать фразу "percent" (процент)
...
- [X] Модуль PropogationMonitor
    - [X] Создать клипы (0-100) количественных числительных в винительном падеже (одного, двух, трех, четырех). При наименовании использовать суффикс 's'
    - [X] Создать клипы для единственного числа единиц метра/мантиметра/градуса/мегагерца
...
- [ ] Аудиоклипы хорошего качества
    [ ] Сформировать строки для пакетной озвучки
        - [X] Default
        - [X] числа
        - [X] фонетические буквы
        - [X] часы, минуты, частоты
        - [ ] фразы
